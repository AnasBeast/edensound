        ...
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
            <div className="flex h-16 justify-evenly">
              <div className="flex px-2 lg:px-0 w-90">
                <div className="flex flex-shrink-0 items-center ">
                  <a href="/dashboard">
                    <img
                      className="block h-8 w-100 lg:hidden"
                ...
                <div className="hidden lg:ml-6 lg:flex lg:space-x-8">
                  ...
                  <a
                    href="/dashboard"
                    className="flex flex-col gap-1 items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700"
                  >
                    Home
              ...
              <div className="hidden lg:ml-4 lg:flex lg:items-center gap-4">
                ...
                <button
                  ...
                  className="flex-shrink-0 rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  <a href="/inbox"> <span className="sr-only">View messages</span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
