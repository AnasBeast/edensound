...
import Comment from './textarea'
import Postsection from './dashboardpost'

const navigation = [
	{ name: 'Dashboard', href: '#', icon: HomeIcon, current: true },
	{ name: 'Friends', href: '#', icon: UsersIcon, current: false },
	{ name: 'Subscriptions', href: '#', icon: CurrencyDollarIcon, current: false },
	{ name: 'Events', href: '#', icon: CalendarIcon, current: false },
	{ name: 'Messages', href: '#', icon: InboxIcon, current: false },
	{ name: 'Support', href: '#', icon: CogIcon, current: false },
]
                ...
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-gray-800 pt-5 pb-4">
                  ...
                  <div className="flex flex-shrink-0 items-center px-4">
                    <img
                      ...
                      src="https://viveca33101.us-east-1.linodeobjects.com/eslogo.svg?color=indigo&shade=500"
                      alt="Your Company"
                    />
                  </div>
        ...
        <main>
            <div className="py-6">
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                ...
                <Comment placeholder="Write something..." button="Post"/>
                {/* /End replace */}
              </div>
            </div>
          </main>
